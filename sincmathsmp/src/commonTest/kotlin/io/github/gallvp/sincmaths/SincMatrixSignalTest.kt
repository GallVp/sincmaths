...
class SincMatrixSignalTest {
    ...
    private fun testMatrixDiff() {
        ...
        SincMathsTest.assert(
            (y.diff(1).iqr(1).mean() - 1.299495936567463).absoluteValue lt SincMathsTest.multSumTestTol,
        )

        SincMathsTest.assert(
            ((100.0 * y).diff(2).iqr(2).mean() - 2.889079408634358).absoluteValue lt SincMathsTest.convTestTol,
        )
    }
    ...
    private fun testMatrixFilter() {
        ...
        SincMathsTest.assert(
            ...
            ).absoluteValue lt SincMathsTest.multSumTestTol,
        )
    }
    ...
    private fun testMovSumEvenDiscard() {
        ...
        SincMathsTest.assert((resultMatlab - result).absoluteValue lt SincMathsTest.convTestTolAndroid)
    }
    ...
    private fun testMovSumOddDiscard() {
        ...
        SincMathsTest.assert((resultOctave - result).absoluteValue lt SincMathsTest.convTestTol)
    }
    ...
    private fun testDenoiseCwtft() {
        ...
        SincMathsTest.assert((resultMATLAB - result).absoluteValue lt SincMathsTest.testTol)
    }
