...
actual operator fun SincMatrix.times(rhs: SincMatrix): SincMatrix {
    ...
    return multiplyRowMajorMatrices(
        this.matrixData,
        lhsM,
        lhsN,
        rhs.matrixData,
...
actual operator fun SincMatrix.plus(rhs: SincMatrix): SincMatrix {
    ...
    return addVectors(this.asRowMajorArray(), rhs.asRowMajorArray()).asSincMatrix(
        this.numRows,
        this.numCols,
    )
}
...
actual infix fun SincMatrix.elMul(rhs: SincMatrix): SincMatrix {
    ...
    return multiplyElementsOfVectors(this.matrixData, rhs.matrixData).asSincMatrix(
        this.numRows,
        this.numCols,
    )
}
...
actual infix fun SincMatrix.elDiv(rhs: SincMatrix): SincMatrix {
    ...
    return divideElementsOfVectors(this.matrixData, rhs.matrixData).asSincMatrix(
        this.numRows,
        this.numCols,
    )
}
